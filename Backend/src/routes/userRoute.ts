...
const athulInteractor = new UserInteractor(userRepo) ;//inject the dependancies for the interactor on the class


//create instance for controller
const userController = new UserController(athulInteractor)
