...
class UserApi {
  ...
  async fetchAllUserData(): Promise<any> {
    try {
      return await this.axiosInstance.get('/admin/allUser');
    } catch (error: unknown) {
  ...
  async blockUser(email:any): Promise<any> {
    try {
      return await this.axiosInstance.post(`/admin/blockUser`,{email});
    } catch (error: unknown) {
  ...
  async unblockUser(email:any): Promise<any> {
    try {
      return await this.axiosInstance.post(`/admin/unblockUser`,{email});
    } catch (error: unknown) {
